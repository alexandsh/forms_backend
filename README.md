...
- **Зайти в контейнер PostgreSQL**: `docker exec -it sl_forms_db psql -U sl_forms -d sl_forms`

- **В открывшейся консоли psql вставить SQL-скрипт из раздела «Инициализация базы данных (создание таблиц)»**.

- **После выполнения скрипта таблицы будут созданы, и приложение сможет работать с базой данных.**
